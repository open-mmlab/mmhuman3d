...
# model settings
model = dict(
    type='ImageBodyModelEstimatorCliff',
    backbone=dict(
...
cache_files = {
    ...
    'coco': 'data/cache/cliff_coco_train_smpl_54.npz',
    'mpii': 'data/cache/cliff_mpii_train_smpl_54.npz',
    'pw3d': 'data/pw3d_train_smpl_54.npz',
}
data = dict(
    samples_per_gpu=32,
    workers_per_gpu=2,
