...
Notes:
- the pretrained models for HMR, SPIN and PARE baseline is currently available.
...
| [resnet50_spin_gta_ft.py](spin/resnet50_spin_gta_ft.py) | 83.20 / 51.98 | [model]() &#124; [log]() |
| [hrnet_w32_conv_pare_gta_ft.py](pare/hrnet_w32_conv_pare_gta_ft.py) | 77.52 / 46.84 | [model]() &#124; [log]() |
