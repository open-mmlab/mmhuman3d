...
# dist_params = dict(backend='nccl', port=29496, rank=0)
...
model = dict(
    ...
    init_cfg=dict(
        type='Pretrained',
        checkpoint=('data/pretrained/hrnet_w32_conv_pare_coco.pth')),
)
...
cache_files = {
    ...
    'agora': 'data/cache/agora_train_smpl_smpl_24.npz'
}
data = dict(
    samples_per_gpu=32,
    workers_per_gpu=8,
    ...
    test=dict(
        ...
        convention='h36m',
        ann_file='agora_validation_smpl.npz'),
)
