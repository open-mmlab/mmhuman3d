...
model = dict(
    ...
    loss_keypoints2d_openpose=dict(type='MSELoss', loss_weight=10),
    loss_keypoints2d_smpl=dict(type='MSELoss', loss_weight=10),
    loss_smpl_pose=dict(type='MSELoss', loss_weight=3),
    loss_smpl_betas=dict(type='MSELoss', loss_weight=0.02),
    loss_vertex=dict(type='L1Loss', loss_weight=0.02),
    loss_segm_mask=dict(type='CrossEntropyLoss', loss_weight=0.02),
    loss_camera=dict(type='CameraPriorLoss', loss_weight=0.02),
    ...
    train=dict(
        ...
        configs=[
            ...
            dict(
                ...
                pipeline=train_pipeline,
                convention='smpl_49',
                ann_file=DATASET_NPZ_PATH+   'spin_mpi_inf_3dhp_train_mmhuman.npz'),
