...
dist_params = dict(backend='nccl', port=29481)
...
cache_files = {
    ...
    'synbody': 'data/cache/synbody_smpl_train_adult_54_1wdata_5views_smpl_54.npz'
}
        ...
        train_dataset=dict(
            ...
            configs=[
                ...
                dict(
                    ...
                    ann_file='synbody_smpl_train_adult_54_5views.npz'),
            ],
