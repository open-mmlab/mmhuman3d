...
model = dict(
    ...
    loss_keypoints2d=dict(type='SmoothL1Loss', loss_weight=0),
...
cache_files = {
    ...
    'synbody': 'data/cache/synbody_smpl_train_adult_cam0_nokp_smpl_54.npz'
}
        ...
        train_dataset=dict(
            ...
            configs=[
                ...
                dict(
                    ...
                    ann_file='synbody_smpl_train_adult_cam0.npz'),
            ],
