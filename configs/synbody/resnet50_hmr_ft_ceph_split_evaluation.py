...
cache_files = {
    ...
    'synbody': 'data/cache/synbody_one_view_adult_54_trainset_humandata_smpl_54.npz'
}
...
data = dict(
        ...
        train_dataset=dict(
            ...
            configs=[
                ...
                dict(
                    ...
                    ann_file='synbody_one_view_adult_54_trainset_humandata.npz'),
            ],
    ...
    test=dict(
        ...
        convention='h36m',
        ann_file='synbody_one_view_adult_54_testset_humandata.npz'),
)
