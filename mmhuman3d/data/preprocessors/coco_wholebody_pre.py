...
def coco_wb_extract(dataset_path, out_path, mode='train'):
    ...
    if mode in ['train', 'val']:
        ...
        raise ValueError('mode does not exist. Valid keys are train or val')
    ...
    keypoints2d_, mask = convert_kps(keypoints2d_, 'coco_wholebody', 'smplx')
