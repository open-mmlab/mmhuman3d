...
class EHFConverter(BaseModeConverter):
    ...
    def convert_by_mode(self, dataset_path: str, out_path: str,
        ...
        for dataname in image_path_:
            ...
            vertices = np.concatenate((np.array(aligndata['vertex']['x']).reshape(-1,1),np.array(aligndata['vertex']['y']).reshape(-1,1),np.array(aligndata['vertex']['z']).reshape(-1,1)),axis = 1)
