...
class H36mHybrIKConverter(BaseModeConverter):
    ...
    def convert_by_mode(self, dataset_path: str, out_path: str,
        ...
        keypoints3d17_ = convert_kps(joint_img_, 'h36m', 'human_data')
        keypoints3d17_cam_ = convert_kps(joint_cam_, 'h36m', 'human_data')
        keypoints3d17_relative_ = convert_kps(
            joint_relative_, 'h36m', 'human_data')
