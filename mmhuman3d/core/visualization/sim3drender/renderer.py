...
class Sim3DR(object):
    def __init__(self, **kwargs):
        self.intensity_ambient = convert_type(kwargs.get("intensity_ambient", 0.3)) #0.66
        self.intensity_directional = convert_type(kwargs.get("intensity_directional", 0.6)) # 0.36
        ...
        self.light_pos = convert_type(kwargs.get("light_pos", (0, 0, 5))) # -5
