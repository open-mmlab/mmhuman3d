...
class DeciWatchPostProcessing:
    ...
    def __init__(self, cfg, device):
        ...
        self.slide_window_q = cfg["slide_window_q"]
        ...
        self.checkpoint_path = os.path.join(
            cfg["checkpoint_dir"], "deciwatch_interval" + str(self.interval) +
            "_q" + str(self.slide_window_q) + ".pth.tar")
    ...
    def __call__(self, x=None):
        ...
        return np.array(output_poses.cpu())
