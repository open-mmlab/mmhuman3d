...
from ..utils.pare_utils import LocallyConnected2d, KeypointAttention, interpolate, softargmax2d
...
class PareHead(BaseModule):
    def __init__(
        ...
        """
        PARE parameters regressor head.
        This class is modified from [PARE](hhttps://github.com/
        ...
        Args:
            ...
            use_scale_keypoint_attention (str):
                Whether to scale the attention according to the size of the attention map.
            backbone (str):
