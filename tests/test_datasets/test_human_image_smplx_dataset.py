...
def test_human_image_smplx_dataset():
    ...
    data_keys = [
        ...
        'center', 'scale', 'has_smplx', 'has_keypoints3d', 'has_keypoints2d','has_smplx_global_orient','has_smplx_body_pose','has_smplx_jaw_pose','has_smplx_right_hand_pose','has_smplx_left_hand_pose','has_smplx_betas','has_smplx_expression',
        'smplx_jaw_pose', 'smplx_body_pose', 'smplx_right_hand_pose', 'smplx_left_hand_pose', 
        'smplx_global_orient', 'smplx_betas','keypoints2d',
        'keypoints3d', 'smplx_expression'
    ]
    ...
    res = test_dataset.evaluate(outputs, res_folder='tests/data', metric=['pa-mpjpe'],body_part = [['body','right_hand','left_hand']])
    ...
    res = test_dataset.evaluate(outputs, res_folder='tests/data', metric=['pa-pve'],body_part = [['', 'right_hand', 'left_hand','face']])
    assert 'PA-PVE' in res
