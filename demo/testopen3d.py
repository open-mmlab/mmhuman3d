...
class Open3d_visualizer(object):
    ...
    def _init_viewer_(self):
        ...
        self.viewer.create_window(width=self.window_size[0], height=self.window_size[1], window_name='vis')

    def _set_view_configs_(self, cam_location, focal_length=5000.):
